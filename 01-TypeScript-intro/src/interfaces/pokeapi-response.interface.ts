...
export class Convert {
    public static toWelcome(json: string): PokeapiResponse {
        return cast(JSON.parse(json), r("Welcome"));
    }

    public static welcomeToJson(value: PokeapiResponse): string {
...
const typeMap: any = {
    "Welcome": o([
        ...
        { json: "past_abilities", js: "past_abilities", typ: a("any") },
